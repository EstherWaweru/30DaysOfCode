...
# is swapped at each of the comparisons, ending in the last position. In the second round, the is swapped at of the

# comparisons. Finally, in the third round, no swaps are made so the iterations stop. The output is the following:
...
# The array
# is not sorted, so we perform the following swaps. Each line shows

# after each single element is swapped.
